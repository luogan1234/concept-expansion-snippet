...
class Config:
    def __init__(self, task, input_text, input_seed, language, snippet_source, no_seed, algorithm, result_path, cpu):
        self.task = task
        ...
        self.proxy = {'http': 'http://localhost:8001', 'https': 'http://localhost:8001'}  # should change to your own proxy
